...
document.body.children[7].children[2];

// 3. Log the number (using console.log) of children of all the `li` element inside the ul with class `topics`

let ul = document.body.children[5];
console.log(`The length of the ul element is ${ul.children.length}`)
...
let topics = querySelector('.topics');
...
let inputCheckBox = querySelector('#remember');
